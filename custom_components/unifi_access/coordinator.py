...
_DEFAULT_POLLING_INTERVAL = timedelta(seconds=3)
...
class UnifiAccessCoordinator(DataUpdateCoordinator[_T]):
    ...
    def __init__(
        ...
        *,
        ...
        polling_interval: timedelta = _DEFAULT_POLLING_INTERVAL,
    ) -> None:
        ...
        super().__init__(
            ...
            update_interval=polling_interval if hub.use_polling else None,
        )
